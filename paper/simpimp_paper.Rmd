...
and are analogous to children's need to identify speakers' intended referent in naturalistic language environment. 
...
A Bayesian linear mixed-effects model predicting accuracy based on age, trial type and number of features (salience contrast; more vs. fewer) showed a three-way positive interaction of age, implicature trials, and number of features (Table \@ref(tab:brms_acc)). Thus, unlike control trials, in which children’s performances did not differ by salience contrast, implicature trials showed lower accuracy in 3-vs-1 than 2-vs-1 trials in younger children, but not in older children. This result supports our initial hypothesis that salience contrast may lead to a greater struggle for younger children with the implicature task due to a higher demand for inhibiting response to distractor with greater salience. 
